...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    ...
	    case 'ADD_CHAIN':
	      var functionsChainCopy = copyOfObj(state.functionsChain);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleClick() {
	      ...
	      var list = this.props.selectedFunctions.slice(0);
	      var fnArray = this.props.selectedFunctions;
	      ...
	      var rec = function rec(arr) {
	        ...
	        if (arr.length === 0) {
	          ...
	          var fnName = arr.pop();
	          var args = arg[fnName].slice(0);
	          if (!!index && !!value) {
	            args[index] = JSON.stringify(value);
	          }
	          try {
	            output = fnDB[fnName].apply(null, args.map(function (a) {
	              return JSON.parse(a);
	            }));
	          } catch (e) {
	            errorMessage = 'Find error from function ' + fnName + '. \n \n            Error type: ' + e.name + '. \n\n            Error message: ' + e.message + ' \n';
	          }
	          if (errorMessage) {
	            result += errorMessage;
	            return result;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ExpressionArea2.default, { key: 0 }),
	        this.props.selectedFunctions.slice(1).map(function (functionName, index) {
	  ...
	  _createClass(ExpressionArea, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        ) : _react2.default.createElement(_Arguments2.default, { functionName: this.state.functionName })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Arguments = function (_React$Component) {
	  ...
	  _createClass(Arguments, [{
	    ...
	    value: function render() {
	      ...
	      var counter = this.props.functionsArg[this.props.functionName].length;
	      return _react2.default.createElement(
	        'div',
	        null,
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.functionsArg[this.props.functionName].map(function (useless, index, array) {
	            return _react2.default.createElement(
	              _DropZone2.default,
	              {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    changeInputValue: function changeInputValue(functionName, argIndex, value) {
	      dispatch((0, _actions.updateInputValue)(functionName, argIndex, value));
	    },
	    selectFunction: function selectFunction(functionName, functionArg, targetFunction, argIndex) {
	      dispatch((0, _actions.addFunction)(functionName, functionArg));
	      dispatch((0, _actions.addChain)(functionName, targetFunction, argIndex));
	    }
	  };
	};
...
/***/ function(module, exports) {
	...
	var addExpressionArea = exports.addExpressionArea = function addExpressionArea() {
	  return {
	    type: 'ADD_EXP_AREA'
	
	  };
	};
	var addFunction = exports.addFunction = function addFunction(functionName, functionArg) {
	...
	var updateInputValue = exports.updateInputValue = function updateInputValue(functionName, argIndex, value) {
	...
	var addChain = exports.addChain = function addChain(currentFunction, targetFunction, argIndex) {
	  return {
	    type: 'ADD_CHAIN',
