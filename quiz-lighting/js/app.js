   ...
   var quizDatabase = [
      {
         ...
         correctChoice:['A'],
         explaination:'Sunlight has a lot blue and UV light. Additionally its CCT is 5500K. ',
      ...
      },
      {
         ...
         correctChoice:['A','B','D'],
         explaination:'The design of the LED is now very flexible and has nice appearance. ',
         displayImg:'images/bulbs.PNG',
      },
      {
         questionId:3,
         question:'What is the price range for 60W equivalent LED bulb in US market? ',
         multChoice:[
            'A. $ 0.20 - $ 1.00',
            'B. $ 0.50 - $ 4.00',
            'C. $ 4.00 - $30.00',
         ...
         correctChoice:['B'],
         explaination:'We can find the cheapest LED bulb on Amazon.com, $1 for two. ',
         displayImg:'images/cost-green.PNG',
      },
      {
         questionId:4,
         question:'As of 2015, what percentage of bulbs in US is still inefficient model? ',
         multChoice:[
            'A. 30%',
            'B. 50%',
            'C. 70%',
         ...
         correctChoice:['C'],
         explaination:'And most of them are incandescent bulbs. ',
         displayImg:'images/cost-green.PNG',
      },
      {
         questionId:5,
         question:'Comparing with traditional incandescent bulb, how much energy does LED bulb save? ',
         multChoice:[
            'A. 90%-80%',
            'B. 80%-70%',
            'C. 70%-60%',
         ...
         correctChoice:['A'],
         explaination:'We can light up an average living room cristal bright using six LED lights, consuming as much electricity as one 40W incandescent bulb. ',
         displayImg:'images/cost-green.PNG',
      },
      {
         questionId:6,
         question:'How long is the lifetime of LED bulbs? ',
         multChoice:[
            'A. >10 years',
            'B. 5 years',
            'C. 2 years',
      ...
      },
      {
         ...
         correctChoice:['D'],
         explaination:'It is measured by R9 which is not listed on the label of regular lighting product. However, the product with CRI 90 usually have high R9.',
